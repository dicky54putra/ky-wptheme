...
class Setup
{
  ...
  public function load_acf_fields()
  {
    ...
    if ($is_public_env) {
      if (file_exists(__DIR__ . '/../fields/ky-acf-fields.php')) {
        include  __DIR__ . '/../fields/ky-acf-fields.php';
      }
  ...
  public function acf_custom_js()
  {
    ...
    if ($screen->id == 'custom-fields_page_acf-tools' && !isset($_GET['keys'])) {
      ...
      wp_localize_script('ky-acf-js', 'objKyAcf', array(
