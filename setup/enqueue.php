...
class Enqueue
{
  ...
  public function __construct()
  {
    ...
    add_action('init', [$this, 'fa_enqueue']);
  ...
  public function admin_enqueue()
  {
    ...
    wp_enqueue_script(
      'admin-js',
      THEME_URL . '/assets/js/dist/admin.min.js',
      ['jquery'],
      'auto',
      true
    );
    ...
    wp_localize_script(
      ...
      [
        ...
        'themeUrl'      => THEME_URL,
        'nonceBE'       => wp_create_nonce('nonceBE'),
        // 'adminEmpWorkScheduleLoadData'   => [
        //   'action'    => 'adminEmpWorkScheduleLoadData',
        // ],
      ]
    );
    ...
    wp_enqueue_style(
      'style',
      THEME_URL . '/assets/css/dist/wp-admin.min.css',
      [],
      'auto'
    );
  }
  ...
  public function theme_styles()
  {
    wp_enqueue_style(
      'style',
      THEME_URL . '/dist/css/build.min.css',
      [],
      'auto'
    );
  }
  ...
  public function theme_scripts()
  {
    wp_enqueue_script(
      'theme',
      THEME_URL . '/dist/js/build.min.js',
      ['jquery'],
      'auto',
      true
    );
    ...
    wp_localize_script(
      ...
      [
        'ajaxUrl'       => admin_url('admin-ajax.php'),
        'themeUrl'      => THEME_URL,
        'nonceFE'       => wp_create_nonce('nonceFE'),
